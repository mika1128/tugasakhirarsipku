        ...
        <main class="main-content full-width">
            <header class="main-header">
                ...
                <nav class="main-navbar">
                    ...
                    <a href="#" class="navbar-item" data-target-section="keluarga" onclick="showSection(event, 'keluarga')">
                        Keluarga
                    </a>
                    <a href="#" class="navbar-item" data-target-section="arsip-vital" onclick="showSection(event, 'arsip-vital')">
                        Arsip Vital
                    </a>
                    <a href="#" class="navbar-item" data-target-section="arsip-inactive" onclick="showSection(event, 'arsip-inactive')">
                        Arsip Inactive
                    </a>
            ...
            <!-- NEW SECTION: Keluarga START -->
            <section class="content-section" id="keluarga">
                <div class="card">
                    <h2 class="section-title"><i class="fas fa-users"></i> Dokumen Keluarga</h2>
                    <div class="table-container">
                        <table id="keluarga-table">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="7" class="loading"> <i class="fas fa-spinner fa-spin"></i><br>
            ...
            <!-- NEW SECTION: Keluarga END -->

            <!-- NEW SECTION: Arsip Vital START -->
            <section class="content-section" id="arsip-vital">
                <div class="card">
                    <h2 class="section-title"><i class="fas fa-file-invoice"></i> Arsip Vital</h2>
                    <div class="table-container">
                        <table id="arsip-vital-table">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="8" class="loading"> <i class="fas fa-spinner fa-spin"></i><br>
            ...
            <!-- NEW SECTION: Arsip Vital END -->

            <!-- NEW SECTION: Arsip Inactive START -->
            <section class="content-section" id="arsip-inactive">
                <div class="card">
                    <h2 class="section-title"><i class="fas fa-folder-minus"></i> Arsip Inactive</h2>
                    <div class="table-container">
            ...
            <!-- NEW SECTION: Arsip Inactive END -->
